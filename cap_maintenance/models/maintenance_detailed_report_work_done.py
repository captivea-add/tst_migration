...
class DetailedReportWorkDone(models.Model):
    ...
    traction_corrective_work_ids = fields.One2many(comodel_name='maintenance.corrective.work.done.traction', inverse_name='traction_maintenance_detailed_report_work_done_id')
    ...
    # Accessoires
    accessories_used_ids = fields.One2many(comodel_name='maintenance.accessories.used', inverse_name='maintenance_detailed_report_work_done_id')
    # Ajout d'huile
